...
func LoadConfigDefault() (cue.Value, error) {
	// default const value
	workpath, err := calcConfigWorkpath()
	if err != nil {
		return cue.Value{}, err
	}
	return LoadConfigConfig(workpath, ConfigEntrypoint)
}
...
func SaveConfigDefault(val cue.Value) error {
	...
	return SaveConfigConfig(workpath, ConfigEntrypoint, val)
}

func calcConfigWorkpath() (string, error) {
	workpath := ConfigWorkpath
