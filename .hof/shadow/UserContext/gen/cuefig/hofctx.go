...
func LoadHofctxDefault() (cue.Value, error) {
	// default const value
	workpath, err := calcHofctxWorkpath()
	if err != nil {
		return cue.Value{}, err
	}
	return LoadHofctxConfig(workpath, HofctxEntrypoint)
}
...
func SaveHofctxDefault(val cue.Value) error {
	...
	return SaveHofctxConfig(workpath, HofctxEntrypoint, val)
}

func calcHofctxWorkpath() (string, error) {
	workpath := HofctxWorkpath
	switch HofctxLocation {
