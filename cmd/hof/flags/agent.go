...
func SetupAgentPflags(fset *pflag.FlagSet, fpole *AgentPflagpole) {
	// pflags
...
var AgentPflags AgentPflagpole

func init() {
	AgentFlagSet = pflag.NewFlagSet("Agent", pflag.ContinueOnError)

	SetupAgentPflags(AgentFlagSet, &AgentPflags)
