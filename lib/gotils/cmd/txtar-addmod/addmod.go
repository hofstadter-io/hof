...
// as understood by the goproxytest package (see https://godoc.org/github.com/hofstadter-io/hof/lib/gotils/goproxytest).
//
// Usage:
//
...
(see https://godoc.org/github.com/hofstadter-io/hof/lib/gotils/goproxytest).
