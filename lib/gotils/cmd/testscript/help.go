...
var mainHelp = `
The testscript command runs github.com/hofstadter-io/hof/lib/gotils/testscript scripts
...
github.com/hofstadter-io/hof/lib/gotils/testscript. The special filename "-" is
interpreted as the standard input.

As a special case, supporting files/directories in the .gomodproxy subdirectory
will be served via a github.com/hofstadter-io/hof/lib/gotils/goproxytest server which
...
github.com/hofstadter-io/hof/lib/gotils/goproxytest for details on the format of these
files/directories.
