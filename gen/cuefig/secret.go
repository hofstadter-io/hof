...
func LoadSecretDefault() (cue.Value, error) {
	// default const value
	workpath, err := calcSecretWorkpath()
	if err != nil {
		return cue.Value{}, err
	}
	return LoadSecretConfig(workpath, SecretEntrypoint)
}
...
func SaveSecretDefault(val cue.Value) error {
	...
	return SaveSecretConfig(workpath, SecretEntrypoint, val)
}

func calcSecretWorkpath() (string, error) {
	workpath := SecretWorkpath
